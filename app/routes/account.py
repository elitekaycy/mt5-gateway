...
def get_account_info():
    ...
    try:
        ...
        if account_info is None:
            ...
            logger.error(
                f"Failed to get account info: {error_str}",
        ...
        logger.info(
            f"Account info retrieved: login={account_info.login}, equity={account_info.equity}, margin_free={account_info.margin_free}"
        )
